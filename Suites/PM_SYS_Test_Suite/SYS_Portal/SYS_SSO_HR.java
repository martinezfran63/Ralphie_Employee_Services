...
public class SYS_SSO_HR {
    ...
    public void SYS_SSO_HR(String portal_sys, String suid_1, String spwd_1, String browser, String environment) throws IOException {
    	String fail = "\nTest Failed";
    	String script = "SYS_SSO_HR";
   	 	System.out.println("\nTest Name: " + script + "\nBroswer: " + browser +"\n"+ "Enviroment: " + 
   	 	environment + "\nURL: " + portal_sys + "\nUsername: " + suid_1 + "\nPasword: " + spwd_1);
        ...
        try
        {
        	System.out.println("4/6 Click Business Applications");
        ...
        try
        {
        	System.out.println("5/6 Click HRMS Link");
        	try { Thread.sleep(10000l); } catch (Exception e) { throw new RuntimeException(e); }
        	wd.findElement(By.linkText("HRMS")).click();
        }
        	catch (Throwable e)
        	{
        		System.out.println("Unable to click HRMS Link"+ fail);
        		PrintScreen capture = new PrintScreen(wd,  browser, environment, script);
        		org.testng.Assert.fail("Unable to click HRMS Link");
        	}
        ...
        try
        {
        	String TexttoVerify= "Human Resource";
