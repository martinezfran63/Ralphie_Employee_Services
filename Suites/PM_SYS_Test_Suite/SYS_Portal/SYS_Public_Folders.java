...
public class SYS_Public_Folders {
	 WebDriver wd;
    ...
    public void SYS_Public_Folders(String portal_sys, String suid_1, String spwd_1, String browser, String environment) throws IOException {
    	String fail = "\nTest Failed"; 
    	String script = "SYS_Public_Folders";
    	System.out.println("\nTest Name: SYS_Public_Folders\n" + "Broswer: " + browser +"\n"+ "Enviroment: " + 
    	 environment + "\nURL: " + portal_sys + "\nUsername: " + suid_1 + "\nPasword: " + spwd_1);
    	...
    	try
    	{
			...
			{
        		System.out.println("Unable to Click Sumbit"+ fail);
        		PrintScreen capture = new PrintScreen(wd,  browser, environment, script);
        		org.testng.Assert.fail("Unable to Click Sumbit");
			}
        ...
        //Click Public Folders Link
    	try
    	{
    		System.out.println("5/6 Click Public Folders Link");
    		try { Thread.sleep(6000l); } catch (Exception e) { throw new RuntimeException(e); }
    		wd.findElement(By.linkText("Public Folders")).click();
        }
        	catch (Throwable e)
			{
        		System.out.println("Unable to click Public Folders Link"+ fail);
        		PrintScreen capture = new PrintScreen(wd,  browser, environment, script);
        		org.testng.Assert.fail("Unable to click Public Folders Link");
			}
        ...
        try
        {
        	...
        	Assert.assertTrue(wd.findElement(By.cssSelector(".headerTitle")).getText().contains(TexttoVerify));
