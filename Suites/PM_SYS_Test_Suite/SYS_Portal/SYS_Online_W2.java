...
public class SYS_Online_W2 {
    ...
    public void SYS_Online_W2(String portal_sys, String suid_1, String spwd_1, String browser, String environment) throws IOException {
    	String fail = "\nTest Failed"; 
    	String script = "SYS_Online_W2"; 
    	System.out.println("\nTest Name: SYS_Online_W2\n" + "Broswer: " + browser +"\n"+ "Enviroment: " + 
    	environment + "\nURL: " + portal_sys + "\nUsername: " + suid_1 + "\nPasword: " + spwd_1);	 
    	 ...
    	 try
    	 {
    		 System.out.println("5/6 Click W2 Link");
    		 try { Thread.sleep(2000l); } catch (Exception e) { throw new RuntimeException(e); }
    		 wd.findElement(By.linkText("W-2")).click();
         }
    	 	catch (Throwable e)
 			{
